...
export default async function Page({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return <OnboardingFrame step={9} title="What keeps you going?" description="This helps AERA coach you without generic motivation." backHref="/onboarding/nutrition" action={saveMotivation} error={error}>
