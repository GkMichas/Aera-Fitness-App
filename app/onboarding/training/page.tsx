...
export default async function Page({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return <OnboardingFrame step={7} title="Your training setup" description="AERA only plans exercises you can actually perform." backHref="/onboarding/activity" action={saveTraining} error={error}>
