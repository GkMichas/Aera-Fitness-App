...
export default function Page() {
  return <OnboardingFrame step={5} title="Progress photos" description="Optional and private by default. JPG, PNG or WebP, up to 10MB each." backHref="/onboarding/measurements" action={savePhotos} submitLabel="Save and continue">
