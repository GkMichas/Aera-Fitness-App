...
export default function Page() {
  return <OnboardingFrame step={4} title="Body measurements" description="Optional. You can update these whenever you want." backHref="/onboarding/about" action={saveMeasurements}>
