...
export default function Page() {
  return <OnboardingFrame step={8} title="How do you like to eat?" description="Your plan should fit your preferences, budget and safety needs." backHref="/onboarding/training" action={saveNutrition}>
